document.addEventListener("DOMContentLoaded", () => {
  ...
  const words = ["luffy", "ohara", "robin", "sanji", "usopp", "jinbe", "marco", "brook", "roger", "germa", "kaido", "usopp", "mochi", 
  "usopp", "smile", "merry", "buggy", "kuzan", "reiju", "drake", "lucci", "teach", "okiku", "usopp", "otama", "koala", "pedro", "sunny", "usopp",
   "moria", "karoo", "vista" ];
